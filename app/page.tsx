    ...
    <main>
      <header className="site-header">
        ...
        <nav aria-label="প্রধান নেভিগেশন">
          <a href="#modules">সেবা</a><a href="#about">কীভাবে কাজ করে</a><a href="#sources">উৎস ও যাচাই</a>
        </nav>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          ...
          <div className="hero-actions"><a className="primary-button" href="#modules">সেবা দেখুন <span>→</span></a><a className="secondary-button" href="#about">কীভাবে কাজ করে</a></div>
          <div className="trust-row"><span>✓ সূত্রভিত্তিক</span><span>✓ নিয়মভিত্তিক হিসাব</span><span>✓ বাংলা প্রথম</span></div>
        </div>
        <div className="hero-panel" aria-label="LandBD overview">
          ...
          <div className="land-card"><div><span className="muted">উদাহরণ জমি</span><strong>২.৫০ শতক</strong></div><div className="mini-stat"><span>খতিয়ান</span><b>RS-১২৩৪</b></div><div className="mini-stat"><span>দাগ</span><b>৪৫৬</b></div><div className="share-bar"><i /><i /><i /><i /></div><small>গণনা ও উৎস আলাদাভাবে সংরক্ষণযোগ্য</small></div>
      ...
      <section className="section" id="modules">
        ...
        <div className="module-grid">{modules.map((module) => <a className="module-card" id={module.href.startsWith('#') ? module.href.slice(1) : undefined} href={module.href} key={module.title}><div className="module-icon">{module.icon}</div><span className="module-tag">{module.tag}</span><h3>{module.title}</h3><p>{module.description}</p><span className="card-arrow">→</span></a>)}</div>
      </section>

      <section className="statement" id="about"><div><span className="eyebrow">LandBD নীতি</span><h2>AI সাহায্য করবে,<br /><em>হিসাবের নিয়ম সিদ্ধান্ত নেবে।</em></h2></div><p>ডকুমেন্ট পড়া, তথ্য খোঁজা ও ফলাফল ব্যাখ্যায় AI ব্যবহার করা যাবে। কিন্তু জমির পরিমাণ, জ্যামিতিক ক্ষেত্রফল বা উত্তরাধিকার অংশের মূল গণনা হবে নির্ধারিত, পরীক্ষাযোগ্য নিয়মে।</p></section>
